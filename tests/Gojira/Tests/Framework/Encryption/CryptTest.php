...
/**
 * Test case for \Gojira\Framework\Encryption\Crypt
 */
class CryptTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor($cipher, $mode)
    {
        ...
        $crypt = new \Gojira\Framework\Encryption\Crypt($this->_key, $cipher, $mode, $initVector);
     ...
     * @expectedException \Gojira\Framework\Exception\LocalizedException
     */
    public function testConstructorException($key, $cipher, $mode, $initVector)
    {
        new \Gojira\Framework\Encryption\Crypt($key, $cipher, $mode, $initVector);
    }

    public function testConstructorDefaults()
    {
        $cryptExpected = new \Gojira\Framework\Encryption\Crypt($this->_key, MCRYPT_BLOWFISH, MCRYPT_MODE_ECB, false);
        $cryptActual = new \Gojira\Framework\Encryption\Crypt($this->_key);
    ...
    public function getCryptData()
    {
        ...
        /* Generate fixtures
           ...
           $crypt = new \Gojira\Framework\Encryption\Crypt($randomKey, $cipher, $mode, $randomInitVector);
           $fixtures[] = array(
    ...
    {
        $crypt = new \Gojira\Framework\Encryption\Crypt($key, $cipher, $mode, $initVector);
    ...
    {
        $crypt1 = new \Gojira\Framework\Encryption\Crypt($this->_key, $cipher, $mode, true);
        $initVector1 = $crypt1->getInitVector();

        $crypt2 = new \Gojira\Framework\Encryption\Crypt($this->_key, $cipher, $mode, true);
    ...
    {
        $crypt = new \Gojira\Framework\Encryption\Crypt($this->_key, $cipher, $mode, false);
