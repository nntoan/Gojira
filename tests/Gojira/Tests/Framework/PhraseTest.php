...
namespace Gojira\Tests\Framework;
...
{
    /**
     * @var \Gojira\Framework\Phrase\RendererInterface
     */
    protected $defaultRenderer;

    /**
     * @var \Gojira\Framework\Phrase\RendererInterface|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->rendererMock = $this->getMockBuilder('Gojira\Framework\Phrase\RendererInterface')
            ->getMock();
    }
    ...
    {
        $this->assertInstanceOf('Gojira\Framework\Phrase\Renderer\Placeholder', Phrase::getRenderer());
    }
}
